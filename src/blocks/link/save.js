      ...
      <div className="wp-block-capitainewp-link__content">
        ...
        <p className="wp-block-capitainewp-link__title">
          <a href={url} target="_blank" rel="noreferrer noopener">
            <img
              className="wp-block-capitainewp-link__favicon"
              alt={title}
              src={favicon}
            />
      ...
      <div className="wp-block-capitainewp-link__meta">
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `type="text/javascript">!function(d,i){if(!d.getElementById(i)){var j=d.createElement("script");j.id=i;j.src="https://widgets.getpocket.com/v1/j/btn.js?v=1";var w=d.getElementById(i);d.body.appendChild(j);}}(document,"pocket-btn-js");`,
          }}
        ></script>
      </div>
    </div>
